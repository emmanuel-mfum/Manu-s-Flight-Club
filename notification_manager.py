...
class NotificationManager:
    ...
    def __init__(self, flights_data, flights_sheet, users_data):
        ...
        self.account_sid = ACCOUNT_SID  # account sid for twilio
        self.auth_token = AUTH_TOKEN  # auth token for twilio
    ...
    def send_emails(self, emails, message, flight_link):
        ...
        with smtplib.SMTP("smtp.gmail.com", 587) as connection:
            ...
            for email in emails:
                connection.sendmail(from_addr=email, to_addrs="*****@outlook.com",
